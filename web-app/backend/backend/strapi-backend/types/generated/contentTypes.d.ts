...
export interface ApiLegalServiceLegalService
  extends Struct.CollectionTypeSchema {
  collectionName: 'legal_services';
  info: {
    displayName: 'LegalService';
    pluralName: 'legal-services';
    singularName: 'legal-service';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::legal-service.legal-service'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::legal-service.legal-service': ApiLegalServiceLegalService;
